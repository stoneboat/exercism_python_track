...
def compile_ingredients(dishes):
    ...
    for i in range(number_of_dishes):
        master_list = master_list | dishes[i]
...
def separate_appetizers(dishes, appetizers):
    ...
    separte_dishes = dishes - appetizers

    return list(separte_dishes)
...
def singleton_ingredients(dishes, intersection):
    ...
    singleton_dishes = set()
    for dish in dishes:
        singleton_dishes |= (dish - intersection)

    return singleton_dishes
